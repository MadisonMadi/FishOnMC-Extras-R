...
public class _DebugField extends Element {
    ...
    private void extractRenderText(GuiGraphicsExtractor guiGraphicsExtractor, Font font, int x, int y) {
        ...
        switch (Configs.debugConfig.debugFieldAlignment.get()) {
            case TOP_LEFT -> GuiGraphicsHelper.text(guiGraphicsExtractor, font, fieldComponent, x, y, StringStyle.SHADOW, StringStyle.MIDDLE);
            case TOP_RIGHT -> GuiGraphicsHelper.text(guiGraphicsExtractor, font, fieldComponent, x - width, y, StringStyle.SHADOW, StringStyle.MIDDLE);
            case BOTTOM_LEFT -> GuiGraphicsHelper.text(guiGraphicsExtractor, font, fieldComponent, x, y - height, StringStyle.SHADOW, StringStyle.MIDDLE);
            case BOTTOM_RIGHT -> GuiGraphicsHelper.text(guiGraphicsExtractor, font, fieldComponent, x - width, y - height, StringStyle.SHADOW, StringStyle.MIDDLE);
        }
    }
    //endregion
}